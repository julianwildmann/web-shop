...
export class SmoothControls extends EventDispatcher {
     ...
     * @param framedHeight
     */
    updateFramedHeight(framedHeight) {
     ...
     */
    update(_time, delta) {
        if (this[$targetSpherical].theta === this[$spherical].theta &&
    ...
    [(_a = $interactionEnabled, _b = $upQuaternion, _c = $upQuaternionInverse, _d = $spherical, _e = $targetSpherical, _f = $previousPosition, _g = $isUserChange, _h = $pointerIsDown, _j = $lastPointerPosition, _k = $velocity, _l = $zoomMeters, $moveCamera)]() {
...
//# sourceMappingURL=SC-old.js.map